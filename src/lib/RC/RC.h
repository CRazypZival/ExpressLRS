...
// ADC校准值 (可根据实际硬件调整)
#define ROLL_CALIBRATION_MAX    3323
#define ROLL_CALIBRATION_MID    2024
#define ROLL_CALIBRATION_MIN    488

#define PITCH_CALIBRATION_MAX   3323
#define PITCH_CALIBRATION_MID   1993
#define PITCH_CALIBRATION_MIN   488

#define THROTTLE_CALIBRATION_MAX 3323
#define THROTTLE_CALIBRATION_MID 1993
#define THROTTLE_CALIBRATION_MIN 488

#define YAW_CALIBRATION_MAX     3323
#define YAW_CALIBRATION_MID     1993
#define YAW_CALIBRATION_MIN     488
